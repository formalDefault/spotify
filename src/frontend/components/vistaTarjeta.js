...
function vistaTarjeta(props) {
    ...
    const estilo = 'bg-white py-2 px-4 rounded-md border-b-2 border-yellow-500 shadow-md';
            ...
            <div className="bg-gray-200 mt-6 p-4">
                ...
                <div className="grid grid-cols-1 gap-4">
                    ...
                    <div className="flex justify-between mb-6">
                        <div className="bg-red-500 px-2 rounded-2xl text-white">Rechazado  <i className="fas fa-times"></i></div>
                        <div className="bg-green-500 px-2 rounded-2xl text-white">Aceptado  <i className="fas fa-check"></i></div>
                    </div>
                    <div onClick={telefono} className="bg-green-600 text-white p-2 w-1/2 rounded-2xl m-auto text-center">
